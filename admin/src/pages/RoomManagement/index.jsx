...
import { Edit2, Trash2, Plus, Save, X, Bed, Check, LayoutGrid, Star, ArrowUpDown } from 'lucide-react';
...
const RoomManagement = () => {
  ...
  const startAdd = () => {
    setEditData({ title: '', description: '', amenities: [], images: [], sort_order: 0 });
    setNewFiles([]);
    setNewAmenity('');
  ...
  const onSaveNew = async () => {
    ...
    const success = await createRoom({ ...editData, sort_order: Number(editData.sort_order) || 0, images: payloadImages });
    if (success) {
      setIsAddModalOpen(false);
      setEditData({});
      setNewFiles([]);
  ...
  const startEdit = (room) => {
    ...
    setEditData({ ...room, images: room.images || [], sort_order: room.sort_order ?? 0 });
    setNewFiles([]);
  };
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-1/3 p-6 border-b lg:border-b-0 lg:border-r border-white/5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <DraggableImageGrid
                        images={editingId === room.id ? editData.images : room.images}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="col-span-2 md:col-span-1">
                            ...
                            <input
                              ...
                              placeholder="0"
                            />
                            <p className="text-[10px] text-slate-500 mt-1.5 px-1">{rooms.length} adet oda içinden <span className="text-[#C5A059] font-semibold">{editData.sort_order ?? 0}.</span> sıradadır</p>
                          </div>
                          ...
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <span className="flex items-center gap-1 bg-white/5 text-slate-400 px-2.5 py-1 rounded-lg text-[11px] font-medium border border-white/5">
                                ...
                                {rooms.length} oda içinden {room.sort_order ?? 0}. sırada
                              </span>
                            </div>
